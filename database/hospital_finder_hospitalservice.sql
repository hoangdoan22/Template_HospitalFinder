...
DROP TABLE IF EXISTS `hospitalservice`;
...
LOCK TABLES `hospitalservice` WRITE;
/*!40000 ALTER TABLE `hospitalservice` DISABLE KEYS */;
/*!40000 ALTER TABLE `hospitalservice` ENABLE KEYS */;
UNLOCK TABLES;
